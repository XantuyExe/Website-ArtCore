...
2. Salin `.env.example` → `.env`, atur koneksi database
3. `php artisan key:generate`
4. `php artisan migrate --seed`
5. Jalankan `npm run dev` dan `php artisan serve`

Selamat mengembangkan lanjutan ArtCore! Jika ada fitur baru, tambahkan ke README ini agar dokumentasi selalu mutakhir.
